...
// Output capture buffer: set these before calling generate() to receive
// the generated text into a buffer (in addition to it being printed).
extern char *g_llm_output_buf;
extern size_t g_llm_output_len;
extern size_t g_llm_output_cap;
